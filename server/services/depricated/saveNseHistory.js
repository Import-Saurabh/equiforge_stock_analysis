// /services/saveNseHistory.js
const yahooFinance = require("yahoo-finance2").default;
const { insertPriceHistory } = require("./insertPrice");

async function saveNsePriceHistory(ticker, companyId) {
  try {
    ...
    console.error(`❌ Failed to fetch NSE history for ${ticker}:`, err.message);
    return false;
  }
}

module.exports = { saveNsePriceHistory };
